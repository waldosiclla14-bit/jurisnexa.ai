  ...
  return (
    <div>
      <button
        ...
        disabled={loading}
        className="w-full flex items-center justify-center gap-3 py-3 bg-white hover:bg-zinc-100 disabled:opacity-50 text-zinc-900 font-medium rounded-lg transition-colors border border-zinc-300"
      >
