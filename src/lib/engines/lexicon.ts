...
export const FIGURE_PATTERNS: FigurePattern[] = [
  {
    ...
    area: 'penal',
    patterns: [
      /(ocup|usurp|invad).{0,60}(con violencia|violentamente|intimidacion|a la fuerza|por la fuerza)/,
      /(con violencia|violentamente|intimidacion|a la fuerza|por la fuerza).{0,60}(ocup|usurp|invad)/,
    ],
    keywords: ['usurpacion', 'ocupacion', 'invasion', 'toma', 'inmueble', 'sitiado', 'okupa', 'ocupante', 'violencia', 'intimidacion', 'fuerza'],
  ...
  },
  {
    ...
    area: 'penal',
    patterns: [
      /(ocup|usurp|invad).{0,60}(dano|romp|destruy|cerradura)/,
      /(dano|romp|destruy|cerradura).{0,60}(ocup|usurp|invad)/,
    ],
  ...
  },
  {
    ...
    area: 'penal',
    patterns: [/ocup/, /usurp/, /invad/, /toma de inmueble/],
